...
const Banner = ({ data }) => {
  return (
    <div className="min-h-[550px] flex justify-center items-center py-12 px-6">
            ...
            <div 
               ...
               className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl">
                ...
                <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
                    ...
                    <div >
                         <button data-aos="fade-up"  className="bg-white text-red-600 rounded-full py-2 px-6 ">Shop now</button>
                    </div>
                </div>
            </div>
        </div>
